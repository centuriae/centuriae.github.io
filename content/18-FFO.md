---
title: Focused Forging Organizations (FFOs)
number: 18
author: Robin Henry
author_link: https://robin-henry.com/
retreat: 2
---
...
Inspired by the concept of [Focused Research Organizations (FROs)](https://fas.org/publication/focused-research-organizations-to-accelerate-science-technology-and-medicine/), I call this new kind of endeavor a *Focused Forging Organization (FFO)*: an organization that takes on a hard real-world problem and uses it as a training ground for producing exceptional people.
...
Character is the set of durable dispositions a person carries with them (such as integrity, humility, drive, courage, accountability, temperance) that show up most clearly under pressure and when no one is watching. It's what [Aristotle used to call *Practical Wisdom*](https://www.ted.com/talks/barry_schwartz_using_our_practical_wisdom?utm_campaign=tedspread&utm_medium=referral&utm_source=tedcomshare). 

There's a growing modern research base treating character as observable and developable rather than fixed or mystical. The work of [Mary Crossan and her colleagues at the Ivey Business School](https://www.amazon.co.uk/Developing-Leadership-Character-Mary-Crossan/dp/1138825670) is a good starting point, and so is the [Oxford Character Project](https://oxfordcharacter.org/) and up-and-coming organizations such as [Virtuosity](https://virtuositycharacter.ca/).
...
*A special thanks to the many people that helped shape this idea through various conversations over the years. Specifically: Corey and Mary Crossan for introducing me to character research, Marcus Lefton and [FRC](https://www.flowresearchcollective.com/) for awesome high-performance insights, and Callum and the whole [Centuriae writing gang](https://centuriae.github.io/index.html).*
